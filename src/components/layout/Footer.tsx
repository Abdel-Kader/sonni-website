                ...
                <div className="md:flex md:justify-between md:items-center md:w-[75%] md:ml-[12%]">
                    <div className="mb-6 md:mb-0 flex-1 mr-12">
                        <a href="https://flowbite.com/" className="flex items-center mb-6">
                            ...
                            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Sonni</span>
                        </a>
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 flex-1">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <a href="https://github.com/themesberg/flowbite" className="hover:underline ">Formation</a>
                                </li>
                                <li>
